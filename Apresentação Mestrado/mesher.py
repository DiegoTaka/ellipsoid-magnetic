...
class EllipsoidTriaxial (GeometricElement):
    ...
    * a, b, c : float
        The radius of the ellipsoid (a>b>c)
    * azimuth, delta, gamma
        The direction angles of the ellipsoid
    * props : dict
    ...
    Examples:
        ...
        >>> e = EllipsoidTriaxial(1, 2, 3, 6, 5, 4, 10, 20, 30, {'remanence': [10000., 25., 40.], 'k': [0.562, 0.485, 0.25, 90., 0., 0.]})
        >>> e.props['remanence']
        [10000.0, 25.0, 40.0]
        ...
        20
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:6.0 | b:5.0 | c:4.0 | azimuth:10.0 | delta:20.0 | gamma:30.0 | density:20 | k:[0.562, 0.485, 0.25, 90.0, 0.0, 0.0] | remanence:[10000.0, 25.0, 40.0]
        >>> e = EllipsoidTriaxial(1, 2, 3, 6, 5, 4, 10, 20, 30)
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:6.0 | b:5.0 | c:4.0 | azimuth:10.0 | delta:20.0 | gamma:30.0
        >>> e.addprop('density', 2670)
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:6.0 | b:5.0 | c:4.0 | azimuth:10.0 | delta:20.0 | gamma:30.0 | density:2670
    ...
    def __init__(self, x, y, z, a, b, c, strike, dip, rake, props=None):
        ...
        assert self.a > self.b and self.b > self.c, "Input axis must have a triaxial ellipsoid shape!"
        self.axis = numpy.array([a, b, c])
        self.center = numpy.array([x, y, z])
    ...
    def __str__(self):
        ...
        names = [('x', self.xc), ('y', self.yc), ('z', self.zc),
    ...
    def V(self, angles=None):
        ...
        * alpha, delta, gamma: float
            Orientation angles of the ellipsoid or susceptibility.
            alpha - Azimuth+180 in relation to the major-axe (a) and the geographic north (0<=alpha<=360, radians).
        ...
        *mcon: matrix
            A 3x3 matrix with direction cosines of the new coordinate system.
        
        Example:

            >>> e = EllipsoidTriaxial(11, 3, 4, 3, 2, 1, 180, 90, 0)
            >>> V = e.V()
            >>> print V
            [[ -6.12323400e-17   1.00000000e+00  -2.44929360e-16]
             [  1.49975978e-32  -2.44929360e-16  -1.00000000e+00]
        ...
        V = numpy.vstack((v1, v2, v3)).T
        
        return V
        
class EllipsoidProlate (GeometricElement):
    ...
    * x, y, z : float
        The coordinates of the center of the ellipsoid
    * a, b : float
        The radius of the ellipsoid (a>b)
    * azimuth, delta, gamma
        The direction angles of the ellipsoid
    * props : dict
        Physical properties assigned to the ellipsoid.
    ...
    Examples:
        ...
        >>> e = EllipsoidProlate(1, 2, 3, 6, 5, 10, 20, {'remanence': [10000., 25., 40.], 'k': [0.562, 0.485, 0.25, 90., 0., 0.]})
        >>> e.props['remanence']
        [10000.0, 25.0, 40.0]
        >>> e.addprop('density', 20)
        >>> print e.props['density']
        20
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:6.0 | b:5.0 | azimuth:10.0 | delta:20.0 | density:20 | k:[0.562, 0.485, 0.25, 90.0, 0.0, 0.0] | remanence:[10000.0, 25.0, 40.0]
        >>> e = EllipsoidProlate(1, 2, 3, 6, 5, 10, 20)
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:6.0 | b:5.0 | azimuth:10.0 | delta:20.0
        >>> e.addprop('density', 2670)
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:6.0 | b:5.0 | azimuth:10.0 | delta:20.0 | density:2670
    ...
    def __init__(self, x, y, z, a, b, strike, dip, rake, props=None):
        ...
        assert self.a > self.b, "Input axis must have a prolate ellipsoid shape!"
    ...
    def V(self, angles=None):
        ...
        * alpha, delta, gamma: float
            Orientation angles of the ellipsoid or susceptibility.
            alpha - Azimuth in relation to the major-axe (a) and the geographic north (0<=alpha<=360, radians).
            delta - Inclination between the major-axe and the horizontal plane (0<=delta<=90, radians).
            gamma - Angle between the intermediate-axe and the vertical projection of the horizontal plane to the
            center of the ellipsoid(radians).
...
class EllipsoidOblate (GeometricElement):
    ...
    * x, y, z : float
        The coordinates of the center of the ellipsoid
    * a, b : float
        The radius of the ellipsoid (b>a)
    * azimuth, delta, gamma
        The direction angles of the ellipsoid
    * props : dict
        Physical properties assigned to the ellipsoid.
    ...
    Examples:
        ...
        >>> e = EllipsoidOblate(1, 2, 3, 5, 6, 10, 20, {'remanence': [10000., 25., 40.], 'k': [0.562, 0.485, 0.25, 90., 0., 0.]})
        >>> e.props['remanence']
        [10000.0, 25.0, 40.0]
        >>> e.addprop('density', 20)
        >>> print e.props['density']
        20
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:5.0 | b:6.0 | azimuth:10.0 | delta:20.0 | density:20 | k:[0.562, 0.485, 0.25, 90.0, 0.0, 0.0] | remanence:[10000.0, 25.0, 40.0]
        >>> e = EllipsoidOblate(1, 2, 3, 5, 6, 10, 20)
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:5.0 | b:6.0 | azimuth:10.0 | delta:20.0
        >>> e.addprop('density', 2670)
        >>> print e
        x:1.0 | y:2.0 | z:3.0 | a:5.0 | b:6.0 | azimuth:10.0 | delta:20.0 | density:2670
    ...
    def __init__(self, x, y, z, a, b, strike, dip, rake, props=None):
        ...
        assert self.b > self.a, "Input axis must have a oblate ellipsoid shape!"
        self.axis = numpy.array([a, b])
        self.center = numpy.array([x, y, z])
    ...
    def VO(self, angles=None):
        ...
        * alpha, delta, gamma: float
            Orientation angles of the ellipsoid or susceptibility.
            alpha - Azimuth in relation to the major-axe (b) and the geographic north (0<=alpha<=360, radians).
            delta - Inclination between the major-axe and the horizontal plane (0<=delta<=90, radians).
            gamma - Angle between the intermediate-axe and the vertical projection of the horizontal plane to the
            center of the ellipsoid(radians).
        ...
        *mcon: matrix
        ...
        v1 = numpy.array([ cos_alpha*sin_delta, 
                          sin_alpha*sin_delta, 
                          -cos_delta])

        v2 = numpy.array([ -cos_alpha*cos_delta,
                          -sin_alpha*cos_delta,
                          -sin_delta])
